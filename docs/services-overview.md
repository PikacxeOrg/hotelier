...
- Packaged as Helm charts under `helm-charts/<service-name>`.
...
- Helm chart: [helm-charts/accommodation-service](../helm-charts/accommodation-service)
...
- Helm chart: [helm-charts/availability-service](../helm-charts/availability-service)
...
- Dockerfile: [services/identity-service/Dockerfile](../services/identity-service/Dockerfile) 
- Helm chart: [helm-charts/identity-service](../helm-charts/identity-service)
- README: [services/identity-service/README.md](../services/identity-service/README.md)

### notification-service
- Purpose: user notifications (emails, push, etc.).
- Dockerfile: [services/notification-service/Dockerfile](../services/notification-service/Dockerfile) 
- Helm chart: [helm-charts/notification-service](../helm-charts/notification-service)
- README: [services/notification-service/README.md](../services/notification-service/README.md)

### rating-service
- Purpose: ratings and reviews.
- Dockerfile: [services/rating-service/Dockerfile](../services/rating-service/Dockerfile) 
- Helm chart: [helm-charts/rating-service](../helm-charts/rating-service)
- README: [services/rating-service/README.md](../services/rating-service/README.md)

### search-service
- Purpose: search and discovery.
- Dockerfile: [services/search-service/Dockerfile](../services/search-service/Dockerfile) 
- Helm chart: [helm-charts/search-service](../helm-charts/search-service)
- README: [services/search-service/README.md](../services/search-service/README.md)

### cdn-service
- Purpose: store and serve images.
- Dockerfile: [services/cdn-service/Dockerfile](../services/cdn-service/Dockerfile)
- Helm chart: [helm-charts/cdn-service](../helm-charts/cdn-service)
...
- Install all services to a Kubernetes cluster via Helm using:
  - Make target: `make deploy` — wrapper uses [etc/scripts/install-services.sh](../etc/scripts/install-services.sh) (see [Makefile](../Makefile)).
- Monitoring stack (Prometheus, Grafana, Loki, Promtail) install:
  - Script: [etc/scripts/install-monitoring.sh](../etc/scripts/install-monitoring.sh)
  - Make targets: `make monitoring-install` / `make monitoring-uninstall` (see [Makefile](../Makefile)).
- Full local setup uses Minikube via [etc/scripts/setup-all.sh](../etc/scripts/setup-all.sh) and Make target `make setup-all` (see [Makefile](../Makefile)).
...
- Monitoring install script: [etc/scripts/install-monitoring.sh](../etc/scripts/install-monitoring.sh)
- Services install script: [etc/scripts/install-services.sh](../etc/scripts/install-services.sh)
